...
class PanopticTracker(SegmentationTracker):
    ...
    def track(
        ...
        **kwargs
        ...
        self._test_area.ins_pre, self._test_area.max_instance = self.block_merging(original_input_ids.cpu().numpy(), originids.cpu().numpy(), curins_pre, self._test_area.ins_pre.cpu().numpy(), self._test_area.max_instance, model.get_opt_mergeTh())
